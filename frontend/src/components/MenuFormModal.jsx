...
function MenuFormModal({ isOpen, onClose, formData, setFormData, onSubmit }) {
    ...
    >
      ...
      >
        ...
        <h2 className="text-2xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500">
          {formData._id ? "Edit Menu" : "Create New Menu"}
        </h2>

        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            <label htmlFor="menu-name" className="block text-sm font-medium mb-1 text-gray-300">
              Menu Name *
            </label>
            <input
              id="menu-name"
              type="text"
              placeholder="e.g. Breakfast, Dinner, Specials"
              value={formData.name}
          ...
          <div>
            <label htmlFor="menu-desc" className="block text-sm font-medium mb-1 text-gray-300">
              Description (optional)
            </label>
            <textarea
              id="menu-desc"
              placeholder="A short description of this menu"
          ...
          <div className="flex justify-end gap-3 pt-4">
            ...
            >
              {formData._id ? "Update Menu" : "Create Menu"}
            </motion.button>
          </div>
        </form>
      </motion.div>
